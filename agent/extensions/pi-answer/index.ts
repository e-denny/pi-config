/**
 * pi-answer — extension entry shim.
 *
 * The real factory lives in src/index.ts; this root-level entry exists so pi
 * labels the extension "pi-answer" in the startup Extensions list instead of
 * "src". pi derives local-extension labels from the entry file's path and
